...
const News = () => {
    ...
    const [news, setNews] = useState([
        ...
        image:"https://i1.wp.com/somosmas.org/wp-content/uploads/2017/11/art-2.png?resize=317%2C235&ssl=1",
        createdAt:"2021-05-26 17:08:31"
        },
        {
            id:"2",
            name:"¡Llega a Colombia la tercera edición del FITS!",
            image:"https://i0.wp.com/somosmas.org/wp-content/uploads/2018/01/Prisma-2.jpg?resize=400%2C250&ssl=1",
            createdAt:"2021-05-23 16:02:01"
        },
        {
            id:"3",
            name:"Encuentro para Innovadores y Emprendedores Sociales",
            image:"https://i1.wp.com/somosmas.org/wp-content/uploads/2017/11/mailing-1.jpg?resize=400%2C250&ssl=1",
            createdAt:"2021-05-24 20:05:12"
        },
        {
            id:"4",
            name:"Consulta Nacional de Alianza por la Niñez ",
            image:"https://i2.wp.com/somosmas.org/wp-content/uploads/2017/11/alianza1.png?resize=400%2C250&ssl=1",
            createdAt:"2021-05-24 20:05:12"
        },
        {
            id:"5",
            name:"Presentes en el Foro Educativo Distrital 2021",
            image:"https://i1.wp.com/somosmas.org/wp-content/uploads/2017/11/foro1.png?resize=400%2C250&ssl=1",
            createdAt:"2021-05-24 20:05:12"
        },
        {
            id:"6",
            name:"Somos Más apoya a la ART",
            image:"https://i0.wp.com/somosmas.org/wp-content/uploads/2020/04/vaki-1.jpg?resize=400%2C250&ssl=1",
            createdAt:"2021-05-24 20:05:12"
        },
        {
            id:"7",
            name:"PROMUEVE LA GARANTÍA DE LOS DERECHOS DE LOS NIÑOS, NIÑAS Y ADOLESCENTES,",
            image:"https://i2.wp.com/somosmas.org/wp-content/uploads/2018/02/27067176_1914361545271622_52931177194889040_n.jpg?resize=400%2C250&ssl=1",
            createdAt:"2021-05-24 20:05:12"
        }
    ...
    //Una vez creada el formularo entries hacer la consulta get para traer los entries de type = news. Mientras tanto se usa un array
    /* const consultarAPi = () =>{
        const consultAPI =async () =>{
            const url = `https://localhost:${API_BASE_URL}/news` 
            await axios.get(url)     
            .then(respuesta =>{
